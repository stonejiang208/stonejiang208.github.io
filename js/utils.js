  ...
  registerLangSelect: function() {
   ...
   registerSidebarTOC: function() {
     ...
     const sections = [...navItems].map(element => {
       ...
       // Skip if link doesn't exist (some TOC items may not have href)
       if (!link) return null;
       
       var href = link.getAttribute('href');
       // Skip if href doesn't exist (root TOC item)
       if (!href) return null;
        ...
        link.addEventListener('click', event => {
          ...
          // Decode URL-encoded href to match actual element IDs
          var decodedId = decodeURIComponent(href.replace('#', ''));
